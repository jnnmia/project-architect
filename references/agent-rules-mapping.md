...
| **Cline / Roo Code** | `.clinerules` | 项目根目录通用指令 |
| **Continue** | `.continue/prompts/project-rules.md` | 提示词与规约目录 |
