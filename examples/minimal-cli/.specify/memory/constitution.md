...
Principles defined:
  1. Architectural Separation & Single Responsibility
  2. Test-Backed Quality Gate (NON-NEGOTIABLE)
  3. Dependency & Resource Discipline
  4. Security, Privacy & Environmental Compatibility

Templates reviewed for alignment:
  [x] plan-template.md: Rules Check gate configured
  [x] spec-template.md: Requirements trace to principles
  [x] tasks-template.md: Testing and quality tasks included
-->

# audioclip Constitution

## Overview
audioclip 是一个 轻量无依赖音频切片与格式转换命令行工具。本文档明确该项目的核心工程规范与底线规则，供功能设计、代码实现、自动化测试与重构共同遵循。

---

## Core Principles

### 1. 架构分离与单一职责 (Architectural Separation & Single Responsibility)
...
### 2. 测试先行与质量保障 (Test-Backed Quality Gate - NON-NEGOTIABLE)
...
### 3. 依赖与资源节约 (Dependency & Resource Discipline)
...
### 4. 安全合规与环境兼容 (Security, Privacy & Environmental Compatibility)
